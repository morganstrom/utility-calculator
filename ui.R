    ...
    fluidRow(
      column(
        ...
        HTML("Where \\(A\\) is the event that a given candidate will perform well on the job (i.e. ends up above the horizontal line of the graph) and 
             ...
             The conditional probability \\(P(A \\mid B)\\) can be calculated exactly using properties of the 
             ...
             If you want to control the results yourself, you should get similar results by dividing the number of green points with the 
